...
require_text README.md "OmniLinkSDK $MAJOR.x"
require_text README.md "Version **$VERSION**"
require_text README.md "OMNILINK_VERSION=$VERSION"
require_text INTEGRATION_GUIDE.md "OmniLinkSDK $MAJOR.x Integration Guide"
require_text INTEGRATION_GUIDE.md "OMNILINK_VERSION=$VERSION"
require_text 00_INTEGRATION_ORDER.md "OmniLinkSDK $MAJOR.x"
require_text 01_OmniLinkSDK_PROMPT.md "OmniLinkSDK $MAJOR.x"
require_text 01_OmniLinkSDK_PROMPT.md "OMNILINK_VERSION=$VERSION"
require_text LINK_PROTOCOL.md "OmniLink $MAJOR.x"
require_text LINK_PROTOCOL.md "$VERSION"
require_text SIGNING_TRUST.md "OmniLink $MAJOR.x"
require_text OMNILINK_TRUST_MESH.md "OmniLink $MAJOR.x"
require_text DESKTOP_TRANSPORT.md "OmniLink $MAJOR.x"
